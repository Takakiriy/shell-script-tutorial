...
function  IfCalcurateAndCompare() {
    ...
    elif (( float "${variable}" / 4.0 == 3.5 )); then  #// 2重カッコであることに注意。小数点があるとエラー
        echo  "${variable} / 4.0 == 3.5"
    elif (( "${variable}" + 1 * 2 == 3 )); then  #// 2重カッコであることに注意
        echo  "${variable} + 1 * 2 == 3"
    elif (( ( "${variable}" + 1 ) * 2 == 0 )); then  #// 2重カッコであることに注意
        echo  "( ${variable} + 1 ) * 2 == 0"
    elif (( "${variable}" / 4.0 == 3.5 )); then  #// 2重カッコであることに注意。小数点があるとエラー
        echo  "${variable} / 4.0 == 3.5"
    else
        echo  "${variable} is in else"
    fi
...
stringVariable2="1"
if (( ${stringVariable1} == 0 )); then
    echo  "\${stringVariable1} is 0."
elif (( ${stringVariable1} == 1 )); then
    echo  "\${stringVariable1} is 1."
else
    echo  "\${stringVariable1} is not 0."
fi
